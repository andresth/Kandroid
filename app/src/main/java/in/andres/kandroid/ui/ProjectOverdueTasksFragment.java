...
//        Log.d("ProjectsFragment", "onCreateView");
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (((MainActivity)getActivity()).getProject() != null) {
            ...
            ProjectTaskAdapter listAdapter = new ProjectTaskAdapter(getContext(), ((MainActivity)getActivity()).getProject(), ((MainActivity)getActivity()).getProject().getGroupedOverdueTasks(), false);
